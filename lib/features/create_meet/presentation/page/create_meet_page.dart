...
import 'package:social_network_app/features/create_meet/presentation/manager/create_meet/create_meet_bloc.dart';
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Scaffold(
        ...
        body: BlocConsumer<CreateMeetBloc, CreateMeetState>(
          ...
          builder: (context, state) {
            ...
            if (state.status == CreateMeetStatus.success) {
              ScaffoldMessenger.of(context).showSnackBar(
                SnackBar(content: Text('Meet created successfully')),
              );
            }
    ...
    return Container(
      ...
      child: GoogleMap(
        ...
        initialCameraPosition: CameraPosition(
          target: location ?? LatLng(36.542841, 36.150188),
          zoom: 10,
        ),
      ),
    );
