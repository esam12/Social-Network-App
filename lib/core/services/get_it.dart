...
import 'package:social_network_app/features/auth/data/repository/user_repository_imp.dart';
...
void registerRepositories() {
  getIt.registerSingleton<AuthRepository>(
    AuthRepositoryImpl(googleSignIn: getIt()),
  );
  getIt.registerSingleton<UserRepository>(
    UserRepositoryImp(userRemoteDatasource: getIt()),
  );
}
